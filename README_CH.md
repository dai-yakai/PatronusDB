...
* [性能测试](#性能测试)
  * [echo QPS](##echo QPS)
  * [Reactor/Ntyco/io_uring QPS](##Reactor/Ntyco/io_uring QPS)
  * [DPDK性能测试](##DPDK性能测试)
  * [持久化](##持久化)
  * [主从同步](##主从同步)
  * [批量处理](##批量处理)
...
* [优化思路](#优化思路)
  * [strcmp/printf/strlen](##strcmp/printf/strlen)
  * [网络层优化](##网络层优化)
    * [用户态缓冲区](###用户态缓冲区)
    * [recv/send调用时机(批量I/O处理 VS 单次I/O处理)](###recv/send调用时机(批量I/O处理 VS 单次I/O处理))
    * [RESP协议](###RESP协议)
    * [DPDK用户态协议栈（F-stack）](###DPDK用户态协议栈（F-stack）)
